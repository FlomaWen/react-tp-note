...
// Récupération des données dans le prop "cocktailsFiltered" | parent : pages/CocktailsFilteredByIngredientsPage.jsx"
const CocktailsFilteredByIngredients = ({ cocktailsFiltered }) => {
  return (
...
export default CocktailsFilteredByIngredients;
