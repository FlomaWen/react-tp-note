...
// Récupération des données dans le prop "cocktailSearched" | parent : pages/SearchResultsPage.jsx"
const SearchResults = ({ cocktailSearched }) => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-10">
      {cocktailSearched.map((cocktail) => (
