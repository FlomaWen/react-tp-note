...
// Récupération des données dans le prop "cocktailsFiltered" | parent : pages/CocktailsFilteredByCategoryPage.jsx"
const CocktailsFilteredByCategory = ({ cocktailsFiltered }) => {
  return (
...
export default CocktailsFilteredByCategory;
